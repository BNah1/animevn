...
class Constants {
  ...
  static const String testVideoUrl =
      'https://s2.phim1280.tv/20230907/S7BVCpM0/index.m3u8';
  ...
  static String content =
      'Phim lấy bối cảnh vào đầu mùa thu năm 2012 tại một trường trung học phổ thông danh tiếng của thành phố Z. Câu chuyện bắt đầu khi nhân vật chính, Tô Tại Tại, trúng tuyển và bước vào trường mới. Ngay từ ngày đầu tiên đến trường, cô bị thu hút bởi Trương Lực Nhượng - một học sinh có tính cách ấm áp và lạc quan như ánh mặt trời. Tình cảm giữa hai người bắt đầu chớm nở khi Tô Tại Tại giúp Trương Lực Nhượng vượt qua sự tự ti, còn Trương Lực Nhượng dần dần giúp cô nhận ra cách lập kế hoạch và mục tiêu cho cuộc sống của mình.\n\nPhim khắc họa những rung động, bỡ ngỡ của tuổi trẻ, cũng như cách các nhân vật dần trưởng thành, tự tìm thấy bản thân và hướng tới một tương lai tươi sáng.';
  static Movie movie1 = Movie(
      ...
      type: 'Hành động',
      posterUrl:
          'https://phimimg.com//upload//vod//20240920-1//9087ee5150f26bac9ae48793befc6c10.jpg',
  ...
  static Movie movie2 = Movie(
      ...
      type: 'Hài',
      posterUrl:
          'https://phimimg.com//upload//vod//20240920-1//265683de955921873753f8802a78ba67.jpg',
      thumbUrl: Constants.testImage,
      time: '100 phút',
      slug: 'asds',
      episodeCurrent: '1',
  ...
  static EpisodeData data1 = EpisodeData(
      slug: 'Tap 1',
      link_m3u8: 'https:\/\/s2.phim1280.tv\/20230907\/S7BVCpM0\/index.m3u8');
  static EpisodeData data2 = EpisodeData(
      slug: 'Tap 2',
      link_m3u8: 'https:\/\/s2.phim1280.tv\/20230907\/IvNmZP16\/index.m3u8');
  static EpisodeData data3 = EpisodeData(
      slug: 'Tap 3',
      link_m3u8: 'https:\/\/s2.phim1280.tv\/20230907\/VOdl4WMe\/index.m3u8');
  static EpisodeData data4 = EpisodeData(
      slug: 'Tap 4',
      link_m3u8: 'ttps:\/\/s2.phim1280.tv\/20230907\/daZYcVlQ\/index.m3u8');

  static Episode episode1 =
      Episode(serverName: 'Wibu', serverData: [data1, data2, data3, data4]);
